...
//class ParagraphContainer(name: String,
//                      qid: Int,
//                      isRelevant: Int,
...
//                      score: Double,
//                      query: String)
//    : DocumentContainer(name, qid, isRelevant, features, docId, searcher, index, score, query, docType = DocumentContainerType.TYPE_PARAGRAPH) {
//
//}
...
//    override fun toString(): String {
////        rescoreParagraph()
////        return "$query 0 $pid ${score.toInt()}"
//
//
//
