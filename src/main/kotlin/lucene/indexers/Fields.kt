...
enum class IndexFields(val field: String) {
    ...
    FIELD_WINDOWED_BIGRAM_3("WINDOWED_BIGRAM_3"),
    FIELD_WINDOWED_BIGRAM_4("WINDOWED_BIGRAM_4"),
    FIELD_WINDOWED_BIGRAM_6("WINDOWED_BIGRAM_6"),
    FIELD_LETTER_2("letter_2"),
    FIELD_LETTER_3("letter_3"),
    FIELD_LETTER_4("letter_4"),
    FIELD_TRIGRAM("trigrams"),
    FIELD_RDF("rdf"),
